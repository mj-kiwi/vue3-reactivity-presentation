...
import { shallowRef, shallowReactive, toRef, toRefs } from '@vue/reactivity'
...
const count1 = shallowRef<number>(0)
const count2 = shallowReactive<Counter>({ counter: { number: 0 } })
const count3 = shallowReactive<Counter>({ counter: { number: 0 } })
